...
typedef struct {
  ...
  int32_T chartAbsoluteTimeCounter;    /* '<Root>/Chart' */
  int32_T durationLastReferenceTick_2; /* '<Root>/Chart' */
  int32_T durationLastReferenceTick_2_g;/* '<Root>/Chart' */
  int32_T durationLastReferenceTick_2_o;/* '<Root>/Chart' */
  int32_T durationLastReferenceTick_2_i;/* '<Root>/Chart' */
  int32_T durationLastReferenceTick_1; /* '<Root>/Chart' */
  ...
  boolean_T condWasTrueAtLastTimeStep_2;/* '<Root>/Chart' */
  boolean_T condWasTrueAtLastTimeStep_2_k;/* '<Root>/Chart' */
  boolean_T condWasTrueAtLastTimeStep_2_j;/* '<Root>/Chart' */
  boolean_T condWasTrueAtLastTimeStep_2_g;/* '<Root>/Chart' */
  boolean_T condWasTrueAtLastTimeStep_1;/* '<Root>/Chart' */
