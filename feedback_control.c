 ...
 * C/C++ source code generated on : Sun May 16 12:02:38 2021
 *
...
static void feedback_control_COMPUTE(real_T feedback_control_U_Echo_IN,
  ...
  D_Work_feedback_control *feedback_control_DWork)
{
  ...
  if (feedback_control_DWork->is_MOVING_AVG == feedback_control_IN_COMPUTE_AVG)
  {
    ...
    if (feedback_control_DWork->online == 0.0) {
      ...
      feedback_control_DWork->Distance_AVG = (((feedback_control_DWork->measure1
        + feedback_control_DWork->measure2) + feedback_control_DWork->measure3)
  ...
  switch (feedback_control_DWork->is_MEASURES) {
   case feedback_control_IN_MEASURE1:
    ...
    if (feedback_control_U_Echo_IN == 0.0) {
      /* Transition: '<S1>:38' */
      /* Exit 'MEASURE1': '<S1>:13' */
      feedback_control_DWork->measure1 = feedback_control_DWork->m1;
      feedback_control_DWork->is_MEASURES = feedback_contr_IN_WAIT_MEASURE2;
    } else {
      condIsTrue = (feedback_control_U_Echo_IN == 1.0);
      if ((!condIsTrue) || (!feedback_control_DWork->condWasTrueAtLastTimeStep_2))
      {
        feedback_control_DWork->durationLastReferenceTick_2 =
          feedback_control_DWork->chartAbsoluteTimeCounter;
      }

      feedback_control_DWork->condWasTrueAtLastTimeStep_2 = condIsTrue;
      feedback_control_DWork->m1 = (((real_T)
        (feedback_control_DWork->chartAbsoluteTimeCounter -
         feedback_control_DWork->durationLastReferenceTick_2)) +
        feedback_control_DWork->step) / 58.0;
    }
    break;
   ...
   case feedback_control_IN_MEASURE2:
    ...
    if (feedback_control_U_Echo_IN == 0.0) {
      /* Transition: '<S1>:41' */
      /* Exit 'MEASURE2': '<S1>:15' */
      feedback_control_DWork->measure2 = feedback_control_DWork->m2;
      feedback_control_DWork->is_MEASURES = feedback_contr_IN_WAIT_MEASURE3;
    } else {
      condIsTrue = (feedback_control_U_Echo_IN == 1.0);
      if ((!condIsTrue) ||
          (!feedback_control_DWork->condWasTrueAtLastTimeStep_2_k)) {
        feedback_control_DWork->durationLastReferenceTick_2_g =
          feedback_control_DWork->chartAbsoluteTimeCounter;
      }

      feedback_control_DWork->condWasTrueAtLastTimeStep_2_k = condIsTrue;
      feedback_control_DWork->m2 = (((real_T)
        (feedback_control_DWork->chartAbsoluteTimeCounter -
         feedback_control_DWork->durationLastReferenceTick_2_g)) +
        feedback_control_DWork->step) / 58.0;
    }
   ...
   case feedback_control_IN_MEASURE3:
    ...
    if (feedback_control_U_Echo_IN == 0.0) {
      /* Transition: '<S1>:44' */
      /* Exit 'MEASURE3': '<S1>:16' */
      feedback_control_DWork->measure3 = feedback_control_DWork->m3;
      feedback_control_DWork->is_MEASURES = feedback_contr_IN_WAIT_MEASURE4;
    } else {
      condIsTrue = (feedback_control_U_Echo_IN == 1.0);
      if ((!condIsTrue) ||
          (!feedback_control_DWork->condWasTrueAtLastTimeStep_2_g)) {
        feedback_control_DWork->durationLastReferenceTick_2_i =
          feedback_control_DWork->chartAbsoluteTimeCounter;
      }

      feedback_control_DWork->condWasTrueAtLastTimeStep_2_g = condIsTrue;
      feedback_control_DWork->m3 = (((real_T)
        (feedback_control_DWork->chartAbsoluteTimeCounter -
         feedback_control_DWork->durationLastReferenceTick_2_i)) +
        feedback_control_DWork->step) / 58.0;
    }
   ...
   case feedback_control_IN_MEASURE4:
    ...
    if (feedback_control_U_Echo_IN == 0.0) {
      /* Transition: '<S1>:48' */
      /* Exit 'MEASURE4': '<S1>:17' */
      feedback_control_DWork->measure4 = feedback_control_DWork->m4;
      feedback_control_DWork->ready_to_compute = 1.0;
      feedback_control_DWork->is_MEASURES = feedback_contro_IN_WAIT_MEASURE;
    } else {
      condIsTrue = (feedback_control_U_Echo_IN == 1.0);
      if ((!condIsTrue) ||
          (!feedback_control_DWork->condWasTrueAtLastTimeStep_2_j)) {
        feedback_control_DWork->durationLastReferenceTick_2_o =
          feedback_control_DWork->chartAbsoluteTimeCounter;
      }

      feedback_control_DWork->condWasTrueAtLastTimeStep_2_j = condIsTrue;
      feedback_control_DWork->m4 = (((real_T)
        (feedback_control_DWork->chartAbsoluteTimeCounter -
         feedback_control_DWork->durationLastReferenceTick_2_o)) +
        feedback_control_DWork->step) / 58.0;
    }
   ...
   case feedback_control_IN_START:
    ...
    if ((feedback_control_U_Echo_IN == 1.0) && (feedback_control_DWork->online ==
      ...
      feedback_control_DWork->m1 = feedback_control_DWork->step / 58.0;
      feedback_control_DWork->condWasTrueAtLastTimeStep_2 =
        (feedback_control_U_Echo_IN == 1.0);
    }
    break;
   ...
   case feedback_contr_IN_WAIT_MEASURE2:
    ...
    if (feedback_control_U_Echo_IN == 1.0) {
      ...
      feedback_control_DWork->m2 = feedback_control_DWork->step / 58.0;
      feedback_control_DWork->condWasTrueAtLastTimeStep_2_k =
        (feedback_control_U_Echo_IN == 1.0);
    } else {
      if (feedback_control_DWork->online == 0.0) {
   ...
   case feedback_contr_IN_WAIT_MEASURE3:
    ...
    if (feedback_control_U_Echo_IN == 1.0) {
      ...
      feedback_control_DWork->m3 = feedback_control_DWork->step / 58.0;
      feedback_control_DWork->condWasTrueAtLastTimeStep_2_g =
        (feedback_control_U_Echo_IN == 1.0);
    } else {
      if (feedback_control_DWork->online == 0.0) {
   ...
   default:
    ...
    if (feedback_control_U_Echo_IN == 1.0) {
      ...
      feedback_control_DWork->m4 = feedback_control_DWork->step / 58.0;
      feedback_control_DWork->condWasTrueAtLastTimeStep_2_j =
        (feedback_control_U_Echo_IN == 1.0);
    } else {
      if (feedback_control_DWork->online == 0.0) {
  ...
  if (feedback_control_DWork->is_CHECK_CONNECTION ==
      feedback_control_IN_CONNECTED) {
    /* Inport: '<Root>/Echo_IN' */
    /* During 'CONNECTED': '<S1>:76' */
    condIsTrue = (feedback_control_U_Echo_IN == 0.0);
    if ((!condIsTrue) || (!feedback_control_DWork->condWasTrueAtLastTimeStep_1))
    {
      feedback_control_DWork->durationLastReferenceTick_1 =
        feedback_control_DWork->chartAbsoluteTimeCounter;
    }

    feedback_control_DWork->condWasTrueAtLastTimeStep_1 = condIsTrue;
    if ((feedback_control_DWork->chartAbsoluteTimeCounter -
         feedback_control_DWork->durationLastReferenceTick_1) > 110000) {
      /* Transition: '<S1>:79' */
    ...
    if (feedback_control_U_Echo_IN == 1.0) {
      ...
      feedback_control_DWork->condWasTrueAtLastTimeStep_1 =
  ...
  feedback_control_Y_Trigger_OUT)
{
  ...
  feedback_control_DWork->condWasTrueAtLastTimeStep_2 = condIsTrue;
  condIsTrue = (feedback_control_U_Echo_IN == 1.0);
  if ((!condIsTrue) || (!feedback_control_DWork->condWasTrueAtLastTimeStep_2_k))
  {
    feedback_control_DWork->durationLastReferenceTick_2_g =
      feedback_control_DWork->chartAbsoluteTimeCounter;
  }
  ...
  feedback_control_DWork->condWasTrueAtLastTimeStep_2_k = condIsTrue;
  condIsTrue = (feedback_control_U_Echo_IN == 1.0);
  if ((!condIsTrue) || (!feedback_control_DWork->condWasTrueAtLastTimeStep_2_j))
  {
    feedback_control_DWork->durationLastReferenceTick_2_o =
      feedback_control_DWork->chartAbsoluteTimeCounter;
  }
  ...
  feedback_control_DWork->condWasTrueAtLastTimeStep_2_j = condIsTrue;
  condIsTrue = (feedback_control_U_Echo_IN == 1.0);
  if ((!condIsTrue) || (!feedback_control_DWork->condWasTrueAtLastTimeStep_2_g))
  {
    feedback_control_DWork->durationLastReferenceTick_2_i =
      feedback_control_DWork->chartAbsoluteTimeCounter;
  }
  ...
  if (feedback_control_DWork->is_active_c3_feedback_control == 0U) {
    /* Entry: Chart */
    feedback_control_DWork->chartAbsoluteTimeCounter = 0;
    ...
    *feedback_control_Y_Trigger_OUT = 1.0;
    ...
    switch (feedback_control_DWork->is_BLINK) {
     case feedback_control_IN_DEFAULT_j:
      ...
      } else if (((feedback_control_DWork->Distance_AVG >= 2.0) &&
     ...
     case feedback_control_IN_ERROR_BLINK:
      ...
      if (((feedback_control_DWork->Distance_AVG >= 2.0) &&
        ...
        feedback_control_DWork->is_BLINK = feedback_control_IN_DEFAULT_j;
      } else if (feedback_control_DWork->is_ERROR_BLINK ==
                 feedback_control_IN_OFF) {
        /* Outport: '<Root>/LED_OUT' */
     ...
     case feedbac_IN_FROM_10_TO_100_BLINK:
      ...
      if ((feedback_control_DWork->Distance_AVG < 2.0) ||
        ...
        if (feedback_control_DWork->is_FROM_10_TO_100_BLINK ==
            feedback_control_IN_OFF) {
          /* Outport: '<Root>/LED_OUT' */
          *feedback_control_Y_LED_OUT = 0.0;

          /* During 'OFF': '<S1>:25' */
          if (feedback_control_DWork->temporalCounter_i2 >= ((uint32_T)ceil
               (((0.1 - LedON) / 1.0E-6) - 1.0E-14))) {
            /* Transition: '<S1>:64' */
            feedback_control_DWork->is_FROM_10_TO_100_BLINK =
              feedback_control_IN_ON;
            feedback_control_DWork->temporalCounter_i2 = 0U;
     ...
     default:
      ...
      if (((feedback_control_DWork->Distance_AVG < 2.0) ||
        ...
        feedback_control_DWork->is_BLINK = feedback_control_IN_DEFAULT_j;
      } else if (feedback_control_DWork->is_OTHER_BLINK ==
                 feedback_control_IN_OFF) {
        /* Outport: '<Root>/LED_OUT' */
        *feedback_control_Y_LED_OUT = 0.0;
    ...
    feedback_control_COMPUTE(feedback_control_U_Echo_IN, feedback_control_DWork);
  }
