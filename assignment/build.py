...
#--- OIL file
oilSourceList.append("periodic.oil")
...
cSourceList.append(projfile.ProjectFile("periodic.c"))
cSourceList.append(projfile.ProjectFile("feedback_control.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("periodic/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("periodic/tpl_os.c"))
