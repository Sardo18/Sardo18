 ...
 * Automatically generated by goil on Wed Jun 23 15:58:39 2021
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm alarm_10msec : stdAppmode */ ,
...
/* Alarm alarm_10msec identifier */
#define alarm_10msec_id 0
CONST(AlarmType, AUTOMATIC) alarm_10msec = alarm_10msec_id;
...
CONST(tpl_task_activation_action, OS_CONST) alarm_10msec_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) alarm_10msec_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , alarm_10msec_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&alarm_10msec_action
};
...
VAR(tpl_time_obj, OS_VAR) alarm_10msec_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&alarm_10msec_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  1,
    /* date                         */  100,
